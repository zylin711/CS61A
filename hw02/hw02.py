...
def missing_digits(n):
    ...
    if n < 10:
        ...
        if last_digit - second_last_digit > 1:
            return missing_digits(n // 10) + (last_digit - second_last_digit - 1)
        else:
...
def count_coins(total):
    ...
    def helper(total, current_coin):
        if total == 0:
            ...
            with_current_coin = helper(total - current_coin, current_coin)
            without_current_coin = helper(total, next_largest_coin(current_coin))
